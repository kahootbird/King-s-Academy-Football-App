      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="android_notification.php">Android Instant Notifications</a></li>
	    <li><a href="team_schedule.php">Team Schedule</a></li>
	    <li class="active"><a href="team_events.php">Team Events</a></li>
         </ul>
         </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Team Events</h2>
...
$sql = "INSERT INTO events (msg) VALUES (' $Event ')"; 
//echo $Title;
if ($Event != NULL)
{
...
$sql = "delete from events where msg =  '" . $delete_data . "'"; 
$conn->query($sql);
}
...
?>
  ...
  Enter Event Data: <input type="text" class="form-control" name="server_notification" value="">
  <br><br>
...
$encoded_msg .= '<tr><td>' 
	...
	.'	<form method="post" action="team_events.php">
<input type="hidden" name="delete_data" value="'  .$row["msg"] . ""  
	.$row["device_notification"] . "".'">  
