  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
	    ...
	    <li class="active"><a href="team_schedule.php">Team Schedule</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Team Schedule</h2>
...
$sql = "INSERT INTO schedule (location) VALUES ('$Event')"; 
...
$sql = "delete from schedule where location =  '" . $delete_data . "'"; 
$conn->query($sql);
}
...
$encoded_msg .= '<tr><td>' 
	...
	.'	<form method="post" action="/fcmtest/team_schedule.php">
